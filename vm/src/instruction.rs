...
impl Instruction {
    pub fn decode(iw: InstructionWord) -> Instruction {
        ...
        match iw.op() {
            ...
            0x1 => Jump(iw.addr()),
            0x2 => Call(iw.addr()),
            0x3 => SkipEqImm { vx: iw.x_reg(), imm: iw.imm(), inv: false },
            0x4 => SkipEqImm { vx: iw.x_reg(), imm: iw.imm(), inv: true },
            0x5 => SkipEqReg { vx: iw.x_reg(), vy: iw.y_reg(), inv: false },
            0x9 => SkipEqReg { vx: iw.x_reg(), vy: iw.y_reg(), inv: true },
            0x6 => PutImm { vx: iw.x_reg(), imm: iw.imm() },
            0x7 => AddImm { vx: iw.x_reg(), imm: iw.imm() },
            0x8 => Apply {
                vx: iw.x_reg(),
                vy: iw.y_reg(),
                f: match iw.n() {
            ...
            0xD => Draw { vx: iw.x_reg(), vy: iw.y_reg(), n: iw.imm4() },
            0xE => {
                match iw.kk() {
                    0x9E => SkipPressed { vx: iw.x_reg(), inv: false },
                    0xA1 => SkipPressed { vx: iw.x_reg(), inv: true },
                    _ => panic!("unrecognized instruction {:?}", iw)
                }
            },
            0xF => {
